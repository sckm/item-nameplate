...
class HyperionGroupieActivity : AppCompatActivity() {

    companion object {
        fun startActivity(context: Context) {
            context.startActivity(Intent(context, HyperionGroupieActivity::class.java))
        }
    }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_hyperion_groupie)
    ...
    private fun setupGroupieItems() {
        ...
        recycler_view.apply {
            layoutManager = GridLayoutManager(this@HyperionGroupieActivity, groupAdapter.spanCount).apply {
